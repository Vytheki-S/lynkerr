    ...
    <div className="min-h-screen bg-[#0A0A0A]">
      <div className="max-w-4xl mx-auto px-6 py-10">
        ...
        {showConfirm && (
          ...
          >
            <div
              className="bg-[#1C1C1C] border border-[#1F2937] rounded-2xl p-8 max-w-sm w-full mx-4"
            ...
            >
              ...
              <div className="flex gap-3">
                <button
                  onClick={() => setShowConfirm(false)}
                  className="border border-[#1F2937] text-[#D1D5DB] px-6 py-2 rounded-lg hover:border-[#F97316] transition flex-1"
                >
                  Cancel
                </button>
                <button
                  ...
                  disabled={deleting}
                  className="bg-[#EF4444] hover:bg-red-700 text-white px-6 py-2 rounded-lg transition flex-1 disabled:opacity-50"
                >
